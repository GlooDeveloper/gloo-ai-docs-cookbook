 ...
 * </ul>
 *
 * <p>Usage: mvn -q compile exec:java -Dexec.mainClass=com.gloo.streaming.tests.Step2ErrorHandlingTest
 */
public class Step2ErrorHandlingTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("   Next: Streaming Requests & SSE Parsing\n");
