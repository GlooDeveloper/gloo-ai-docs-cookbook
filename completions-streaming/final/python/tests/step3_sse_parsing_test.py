...
Usage: python tests/step3_sse_parsing_test.py
"""
...
def test_step2():
    ...
    try:
        ...
        try:
            make_streaming_request("Hello", "invalid-token-xyz")
            ...
            if (
                ...
                raise Exception(f"Expected auth error, got: {msg}")

        print("\n✅ Streaming request and SSE parsing working.")
        print("   Next: Token Extraction & Accumulation\n")
