/**
 * Gloo AI Upload Files - JavaScript Example
 *
 ...
 */
async function uploadSingleFile(filePath, producerId = null) {
 ...
 */
async function updateMetadata(itemId = null, producerId = null, metadata = {}) {
 ...
 */
async function cmdUploadSingle(filePath, producerId = null) {
  try {
 ...
 */
async function cmdUploadBatch(directoryPath) {
 ...
 */
async function cmdUploadWithMetadata(filePath, metadata) {
  try {
...
function printUsage() {
  console.log("Usage:");
  console.log(
    "  node index.js single <file_path> [producer_id]  # Upload single file"
  );
  console.log(
    "  node index.js batch <directory>                  # Upload all files in directory"
  );
  console.log(
    "  node index.js meta <file_path> --title <title>   # Upload with metadata"
  );
  console.log("");
  console.log("Examples:");
  console.log("  node index.js single ../sample_files/developer_happiness.txt");
  console.log(
    "  node index.js single ../sample_files/developer_happiness.txt my-doc-001"
  );
  console.log("  node index.js batch ../sample_files");
  console.log(
    '  node index.js meta ../sample_files/developer_happiness.txt --title "Developer Happiness"'
  );
}
 ...
 */
function parseMetadataArgs(args) {
  const metadata = {};
