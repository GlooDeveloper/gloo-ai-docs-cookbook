# Upload Files - JavaScript Example

This example demonstrates how to use the Gloo AI Data Engine Files API with JavaScript to upload files directly for processing and AI-powered search.
...
```bash
node index.js single ../sample_files/developer_happiness.txt
```
...
```bash
node index.js batch ../sample_files
```
...
```bash
node index.js meta ../sample_files/developer_happiness.txt --title "Developer Happiness" --author "John Doe" --tags "development,culture"
```
