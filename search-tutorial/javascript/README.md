# Search API - JavaScript Example

This example demonstrates how to use the Gloo AI Search API with JavaScript (Node.js) to perform semantic search on your ingested content.
...
```bash
node search-basic.js "How can I know my purpose?"
```

With custom result limit:
```bash
node search-basic.js "purpose" 5
```
...
```bash
node search-advanced.js filter "purpose" "Article,Video" 10
```
